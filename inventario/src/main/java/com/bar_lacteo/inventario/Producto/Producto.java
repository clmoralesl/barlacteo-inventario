...
public class Producto {
    ...
    public Producto(Integer codigoBarra, String nombreProducto, String descripcion, Integer precioUnitario,
            Integer stockMininmo, Categoria categoria) {
        this.codigoBarra = codigoBarra;
        this.nombreProducto = nombreProducto;
        this.descripcion = descripcion;
        this.precioUnitario = precioUnitario;
        this.stockMininmo = stockMininmo;
    ...
    public Integer getStockMininmo() {
        return stockMininmo;
    }



    public void setStockMininmo(Integer stockMininmo) {
        this.stockMininmo = stockMininmo;
    }
